...
from chiplog.capabilities.agent_loop.contracts import Complete, Continue, Frozen
...
def validate_envelope(envelope: FanOutPhysicalEnvelope) -> FanOutPhysicalEnvelope:
