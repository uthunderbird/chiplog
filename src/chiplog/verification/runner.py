...
def _check_stage0(root: Path) -> list[CheckResult]:
    ...
    slices = {
        ...
        "R2": (
            ...
            "tests/architecture/test_r1_r2_contract.py",
            "tests/architecture/test_r4_r5_freeze.py",
            "tests/verification/test_inert_shared.py",
            "tests/verification/test_manifest_contract.py",
            "tests/verification/test_manifest_mutants.py",
            "tests/verification/test_r4_r5_freeze.py",
        ),
        "R3": (
            "tests/platform/test_deletion_provenance.py",
            "tests/platform/test_evidence_inbox.py",
            "tests/platform/test_sqlite_substrate.py",
        ),
        "R4": ("tests/capabilities/deployment_trust/test_trust.py",),
        "R5": (
            "tests/architecture/test_r4_r5_convergence.py",
            "tests/capabilities/planning/test_planning.py",
            "tests/capabilities/projections/test_projection.py",
        ),
        "R6": (
            "tests/capabilities/deployment_trust/test_trust.py::test_cli_authentication_and_complete_reference_revalidation",
            "tests/capabilities/deployment_trust/test_trust.py::test_cli_peer_credential_is_durable_and_exact",
            "tests/capabilities/deployment_trust/test_trust.py::test_current_reference_revalidation_rejects_each_binding_substitution",
            "tests/capabilities/planning/test_planning.py::test_trust_revalidation_binds_exact_operation_and_allocation_subject",
            "tests/cli/test_corrupt_store.py::test_canonical_cli_rejects_corrupt_authority_before_output",
            "tests/composition/test_planning_journeys.py::test_authorized_planning_persists_multiple_commands_and_renders_after_restart",
            "tests/composition/test_planning_journeys.py::test_current_identity_substitution_denies_without_publication",
            "tests/composition/test_planning_journeys.py::test_invalid_planning_command_leaves_authoritative_state_unchanged",
            "tests/composition/test_planning_journeys.py::test_runtime_records_authenticated_identity_and_exact_owner_inputs",
            "tests/composition/test_r8_runtime.py::test_actual_publication_cut_rejects_changed_inputs_without_result",
            "tests/composition/test_r8_runtime.py::test_canonical_r8_runtime_traces_before_durable_planning_publication",
        ),
        "R7": (
            "tests/architecture/test_canonical_entrypoint.py",
            "tests/architecture/test_inert_owner_models.py",
            "tests/architecture/test_owner_imports.py",
            "tests/architecture/test_r7_compatibility.py",
            "tests/architecture/test_read_invalidation_manifest.py",
            "tests/architecture/test_runtime_manifest.py",
            "tests/capabilities/planning/test_r7_boundary.py",
            "tests/composition/test_graph_contract.py",
            "tests/composition/test_owner_process_isolation.py",
            "tests/composition/test_r7_planning_runtime.py",
            "tests/composition/test_runtime_restart.py",
            "tests/composition/test_trust_admission.py",
            "tests/platform/test_authority_ledger.py",
            "tests/platform/test_authority_reads.py",
            "tests/platform/test_broker_contract.py",
            "tests/platform/test_broker_peer_authentication.py",
            "tests/platform/test_broker_routing.py",
            "tests/platform/test_planning_boundary.py",
            "tests/platform/test_read_release_order.py",
            "tests/verification/test_inert_owner_models.py",
            "tests/verification/test_r7_bypass.py",
            "tests/verification/test_r7_compatibility.py",
            "tests/verification/test_read_invalidation.py",
        ),
        "R8": (
