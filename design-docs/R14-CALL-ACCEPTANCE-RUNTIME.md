...
The development worktree is based on db5e5bd. Published master f9790f7 additionally
contains ingress provenance preservation. Integration must retain both changes and
verify the combined tree; that provenance increment is absent from this base.
