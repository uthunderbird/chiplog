...
- **Hybrid format:**
  ...
  - Questions with genuinely discrete branches (A/B/C, mutually exclusive) → use the available structured question tool; if none is available, ask a concise direct question. Put the recommended option first.
...
- Forcing open-ended questions into a multiple-choice question.
